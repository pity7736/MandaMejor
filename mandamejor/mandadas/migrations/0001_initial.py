    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_name', models.CharField(blank=True, max_length=30, verbose_name='segundo nombre')),
                ...
                ('date_joined', models.DateTimeField(auto_now_add=True, verbose_name='date sing up')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mandadas', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
